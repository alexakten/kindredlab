            ...
            <nav className="z-50 flex w-full max-w-8xl items-center justify-between px-4 py-3 text-xs font-medium sm:px-16">
              ...
              >
                <div className="flex items-center justify-center gap-1">
                  <p className="relative font-sabon text-xl font-semibold leading-[0.95] tracking-[-0.010rem]">
                    kindred
              ...
              <div className="flex gap-4">
                <Link
                  ...
                  gap-3 rounded-full bg-white px-4 py-1.5 font-basier text-xs text-black hover:bg-zinc-200"
                  scroll={false}
                  replace
                >
                  {dict.nav.cta}
                  <span className="flex h-6 w-8 items-center justify-center rounded-[4px] border border-zinc-300 bg-zinc-100 text-[12px]">
                    ⌘ K
                  </span>
                </Link>
              </div>
