  ...
  return (
    <nav className="fixed z-50 flex w-full max-w-8xl items-center justify-between px-8 py-4">
      ...
      <div className="flex gap-4">
        ...
        >
          <p className="text-sm font-medium">Book demo</p>
          <span className="flex h-5 w-5 items-center justify-center rounded-[4px] bg-zinc-800 text-[10px]">
            B
          </span>
        </Link>
        <Link
          href="mailto:hello@kindredlab.io"
          className="rounded-lg bg-zinc-50 px-3 py-2 text-sm font-medium text-zinc-950 hover:bg-white"
        >
          Say hello
        </Link>
      </div>
