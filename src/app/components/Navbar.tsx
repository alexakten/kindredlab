...
export default function Navbar() {
  return (
    <nav className="flex items-center justify-center">
      ...
      >
        <div className="fixed z-50 mt-4 flex max-w-3xl items-center justify-between rounded-2xl border border-white border-opacity-20 bg-white bg-opacity-5  py-1.5 pl-3 pr-2 text-xs font-medium backdrop-blur-md">
