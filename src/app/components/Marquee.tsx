...
const Marquee = () => {
  return (
    <div className='marquee-wrapper max-w-8xl overflow-hidden relative flex flex-col gap-4'>
      <div className='absolute z-10 bg-gradient-to-l from-transparent to-white left-0 top-0 h-full w-24'></div>
      <div className='absolute z-10 bg-gradient-to-r from-transparent to-white right-0 top-0 h-full w-24'></div>
